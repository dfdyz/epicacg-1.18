...
public class UnityCompsite extends PostEffectBase{
    public UnityCompsite(EffectInstance effect) {
        super(effect);
    }

    public UnityCompsite(String resourceLocation, ResourceManager resmgr) throws IOException {
